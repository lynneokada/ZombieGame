...
- (void)touchBegan:(CCTouch *)touch withEvent:(UIEvent *)event
{
    ...
    if (CGRectContainsPoint([leftButton boundingBox], touchLocation))
    {
        ...
        {
            [[OALSimpleAudio sharedInstance] playEffect:@"Published-iOS/ccbResources/ART/pistolSound.caf"];
        ...
        {
            [[OALSimpleAudio sharedInstance] playEffect:@"Published-iOS/ccbResources/ART/shotgunSound.caf"];
        ...
        {
            [[OALSimpleAudio sharedInstance] playEffect:@"Published-iOS/ccbResources/ART/flamethrowerSound.caf"];
        ...
        {
            [[OALSimpleAudio sharedInstance] playEffect:@"Published-iOS/ccbResources/ART/grenadeSound.caf"];
